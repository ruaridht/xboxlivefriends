//
//  AIHaloScreenshotsController.m
//  Xbox Live Friends
//
//  Created by Ruaridh Thomson on 21/04/2010.
//  Copyright 2010 __MyCompanyName__. All rights reserved.
//
//  Mostly the same as GIHaloScreenshotController

#import "AIHaloScreenshotsController.h"
...
@implementation AIHaloScreenshotsController

- (id)init {
	if (![super init])
		return nil;
	
	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(tabSelectionChanged:) name:@"AccountInfoTabWillChange" object:nil];
...
- (NSString *)notificationName {
	return @"AIHaloScreenshotLoadNotification";
}
